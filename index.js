...
export default function(str) {
  ...
  var scenex = {
    ...
    audio:      /(AAC[0-9][\.\s][0-9]|AAC)|(DTS([\.\s\-](HD[\.\s\-]MA|HD|MA)([\.\s][0-9][\.\s][0-9]|))?|DTS([0-9][\.\s][0-9])?)|(AC3([\.\s](DD([0-9][\.\s][0-9])?)?)?)|(DD([\+][0-9][\.\s][0-9]|[\.\s\+]ATMOS))|(DD(P)?[0-9][\.\s][0-9]([\.\s]ATMOS)?)|(TRUEHD[\.\s][0-9][\.\s][0-9])|(ATMOS)/i,
    other:      /UHD|DOCU/i,
    group:      /\w+$/i
  };
