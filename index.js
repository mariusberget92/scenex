...
export default function(str) {
  ...
  var scenex = {
    ...
    type:       /CAM|\bTS(?!C)\b|TELESYNC|(DVD|BD)SCR|SCR|DDC|R5[\.\s]LINE|R5|(DVD|HD|BR|BD|WEB)Rip|DVDR|(HD|PD)TV|WEB-DL|WEBDL|BluRay/i,
    audio:      /AAC2[\.\s]0|AAC|(DTS-HD[\.\s]MA[\.\s]5[\.\s]1|DTS[0-9][\.\s][0-1]|DTS)|(AC3[\.\s](DD2[\.\s]0|DD5[\.\s]1)|AC3|DD[\+]5[\.\s]1|DD5[\.\s]1)|(DDP5[\.\s]1)/i,
    group:      /\w+$/i
  };
