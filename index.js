...
export default function(str) {
  ...
  var scenex = {
    ...
    video:      /(REMUX?[\.\s](AVC|HEVC)?)|((AVC|HEVC)?[\.\s]?REMUX)|NTSC|PAL|[xh]?[\.\s]?(264|265)/i,
    release:    /REAL[\.\s]PROPER|PROPER|REPACK|READNFO|READ[\.\s]NFO|DiRFiX|NFOFiX/i,
    lang:       /MULTISUBS|MULTI|NORDIC|ENG|DANISH|SWEDISH|NORWEGIAN|GERMAN|ITALIAN|FRENCH|SPANISH/i,
    edition:    /UNRATED|DC|REMASTERED|(Directors|EXTENDED)[\.\s](CUT|EDITION)|EXTENDED|3D|2D|\bNF\b|\bAMZN\b/i,
    type:       /CAM|\bTS(?!C)\b|TELESYNC|(DVD|BD)SCR|SCR|DDC|R5[\.\s]LINE|R5|(DVD|HD|BR|BD|WEB)Rip|DVD|DVDR|(HD|PD)TV|WEB-DL|WEBDL|BluRay|WEB/i,
    audio:      /AAC2[\.\s]0|AAC|(DTS-HD[\.\s]MA[\.\s]5[\.\s]1|DTS[0-9][\.\s][0-1]|DTS)|(AC3[\.\s](DD2[\.\s]0|DD5[\.\s]1)|AC3|DD[\+]?Atmos?5[\.\s]1|DD5[\.\s]1)|(DDP5[\.\s]1)|(TRUEHD[\.\s]5[\.\s]1)/i,
    other:      /UHD|DOCU/i,    
    group:      /\w+$/i
  };
